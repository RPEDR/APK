  ...
  ley10: [
    ...
    // Pregunta 14
    {
      ...
      options: [
        "Puede hacerlo",
        "No puede hacerlo",
        "Puede suspender la licencia temporalmente",
        "Puede imponer una multa al corredor"
      ],
    ...
    // Pregunta 29
    {
      ...
      options: [
        ...
        "Se requiere que ambos Instructores sean Corredores de Bienes"
      ],
      answer:
        "Ahora el Instructor General tiene que ser Corredor de Bienes Raíces, pero no así el Instructor Especializado"
    }
  ...
  etica: [
    // Pregunta 30
    {
      ...
      options: [
        ...
        "Es ético si el financiamiento ofrece las mejores condiciones para Pedro Comprador.",
    ...
    // Pregunta 36
    {
      ...
      options: [
        ...
        "No actualizar la información de contacto en publicidad y anuncios."
      ],
    ...
    // Pregunta 37
    {
      ...
      options: [
        ...
        "No ética a menos que haya una expectativa razonable de obtener dicho consentimiento."
      ],
      answer:
        "No ética porque no puede ofrecer a propiedad a la venta sin el consentimiento del dueño."
    },
    // Pregunta 38
    {
      ...
      options: [
        ...
        "No fue ético ya que debió obtener el consentimiento del cliente para el cambio."
      ],
      answer:
        "Juan no fue ético porque tenía que haber mantenido informado de cualquier cambio relacionado a la transacción."
    },
    // Pregunta 39
    {
      ...
      options: [
        ...
        "No fue ético porque interfiere con el acuerdo exclusivo de otro corredor.",
    ...
    // Pregunta 40
    {
      ...
      options: [
        ...
        "No fue ético porque debió dirigir sus preocupaciones a Ricardo o a la autoridad competente.",
  ...
  daco: [
    ...
    // Pregunta 53
    {
      ...
      options: [
        ...
        "Es la renovación de una inscripción previa con cambios en el material de promoción."
      ],
      answer:
        "Es cualquier inscripción hecha ante el Departamento de Asuntos del Consumidor de información o material de promoción o venta relacionado con el ofrecimiento o la venta de bienes inmuebles localizados fuera del Estado Libre Asociado de Puerto Rico, a la cual haya precedido una inscripción inicial de, o cualquier alteración a la información o material de promoción relacionado con la venta de dichos bienes inmuebles."
    },
    ...
    // Pregunta 55
    {
      ...
      options: [
        ...
        "Sin Abogado",
        "Personalmente",
        "A través de un representante legal o un director"
      ],
      answer: "Con Abogado"
    },
    // Pregunta 56
    {
      ...
      options: [
        ...
        "Solicitar la mediación de un tercero"
      ],
    ...
    // Pregunta 57
    {
      ...
      options: [
        ...
        "Cuasi-legislativos",
        "Cuasi-judiciales y Cuasi-legislativos",
        "Administrativos y deliberativos"
      ],
    ...
    // Pregunta 60
    {
      ...
      options: [
        ...
        "Pública por defecto, a menos que se solicite y justifique una sesión privada"
      ],
      answer:
        "Pública, a menos que se solicite privada y el funcionario que preside la Vista lo autorice"
    },
  ...
  leyCondominios: [
    ...
    // Pregunta 67
    {
      ...
      options: [
        ...
        "Que todo dueño debe declarar ingresos por alquileres.",
        "Que se deben pagar tasas adicionales por alquileres a corto plazo."
      ],
      answer:
        "Que todo dueño que renta a corto plazo (90 días o menos) debe de pagar un impuesto habitación (room tax) de 7%."
    },
    ...
    // Pregunta 71
    {
      ...
      options: [
        ...
        "Únicamente las deudas correspondientes a los gastos comunes regulares.",
        "Todas las deudas acumuladas sin excepción."
      ],
      answer:
        "Las deudas por gastos comunes surgidas y no satisfechas durante los seis (6) meses anteriores al momento de adquirir la propiedad excepto las partidas correspondientes a penalidades por atrasos o mora, derramas, intereses y sanciones atribuibles al titular, incluirá el balance corriente que se acumule desde la adquisición de dicho inmueble por parte del adquiriente involuntario."
    },
    ...
    // Pregunta 81
    {
      ...
      options: [
        ...
        "Debe constituirse como una asociación sin fines de lucro."
      ],
    ...
    // Pregunta 83
    {
      ...
      options: [
        ...
        "Un espacio destinado para vivienda que forma parte de un edificio de varios pisos, donde cada unidad es propiedad individual, pero con acceso a espacios y servicios comunes."
      ],
      answer:
        "Cualquier unidad de construcción en un inmueble sometido al régimen establecido en este capítulo, que se encuentre suficientemente delimitada y que consista en uno (1) o más espacios cúbicos total o parcialmente cerrados o abiertos, juntamente con sus anejos, si alguno, aunque estos no sean contiguos, siempre que tal unidad sea susceptible de cualquier tipo de aprovechamiento independiente y tenga salida directa a la vía pública o a determinada área privada."
    },
    ...
    // Pregunta 96
    {
      ...
      options: [
        ...
        "Sólo al presidente.",
        "A los miembros de la Junta de Directores y comités especiales."
      ],
    ...
    // Pregunta 97
    {
      ...
      options: [
        ...
        "Cuando se haya vendido el 30% de los apartamentos y se convoque a una asamblea especial.",
        "Cuando lo decida el Desarrollador, sin importar el porcentaje de apartamentos vendidos."
      ],
      answer:
        "Cuando se haya vendido el 40% de los apartamentos, y el Desarrollador convoque a los titulares a una asamblea a esos efectos. También podrá ser constituido en cualquier momento previo a la venta del 40% mediante la celebración de una asamblea, convocada por cualquier titular que no sea el Administrador Interino o Desarrollador."
    },
  ...
  legal: [
    // Pregunta 106
    {
      ...
      options: [
        "No es responsable.",
        "Es responsable.",
        "Solo es responsable si tenía conocimiento de los vicios.",
        "Es responsable si no realizó una inspección adecuada."
      ],
    ...
    // Pregunta 107
    {
      ...
      options: [
        ...
        "El Notario es seleccionado de común acuerdo entre las partes."
      ],
      answer:
        "El que escoge el Notario pagará sus honorarios, salvo pacto en contrario."
    },
    ...
    // Pregunta 111
    {
      ...
      options: [
        ...
        "El documento debe ser leído por otra persona en presencia del Notario.",
    ...
    // Question 113
    {
      ...
      options: [
        ...
        "El dueño no tiene obligación hasta que el comprador ejecute la opción."
      ],
      answer:
        "El comprador tiene la opción de cumplir con el contrato y el dueño se obliga. Es un contrato unilateral."
    }, // Pregunta 114
    {
      ...
      options: [
        ...
        "Todos los costos asociados con la transacción.",
        "Los costos acordados en el contrato de compraventa."
      ],
      answer:
        "Los honorarios y sellos de la copia certificada más los comprobantes de inscripción."
    },
    ...
    // Pregunta 117
    {
      ...
      options: [
        ...
        "Una sociedad para la administración de bienes adquiridos durante el matrimonio."
      ],
    ...
    // Pregunta 172
    {
      ...
      options: ["Casa, Terreno", "Mueble", "Vehículo", "Joyería"],
      answer: "Casa, Terreno"
    },
    // Pregunta 173
    {
    ...
    // Pregunta 219
    {
      ...
      options: [
        ...
        "Ilegal, porque viola los derechos del deudor"
      ],
    ...
    // Pregunta 238
    {
      ...
      options: [
        ...
        "No tiene razón, porque el dinero se obtuvo antes del matrimonio"
      ],
      answer:
        "No tiene razón, porque ese dinero es un bien privativo de Mariana"
    },
    ...
    // Pregunta 239
    {
      ...
      options: [
        ...
        "No, porque las capitulaciones matrimoniales no pueden ser modificadas"
      ],
      answer:
        "No, porque una vez te casas, las capitulaciones no se pueden modificar ni por el Tribunal"
    },
    ...
    //Pregunta 242
    {
      ...
      options: [
        ...
        "Legal, porque el contrato de subarrendamiento está por encima del contrato original"
      ],
      answer:
        "Legal, porque en el Contrato el Arrendador no se le prohibió al Arrendatario subarrendar"
    },
